...
public class DeliveryController extends BaseController{
	...
	public String submitDelivery(@RequestParam(value = "deliveryNo", required = true) String deliveryNo,
		...
		deliveryService.addsingleDelibery(customer, logisticsDate, companyName, logisticsNo, productName, barCode, category, quantity, color, number, note, volume, weight, deliveryNo);
